      ...
      items: [
        {
          ...
          desc: 'אני בונה אתרי פרימיום שמציגים אותך כבחירה הברורה, מחזקים אמון מהרגע הראשון ומובילים לקוחות לפעולה.',
        },
        {
          title: 'ניהול לידים ותוכן',
          desc: 'כלים פשוטים לניהול לידים, תוכן ולקוחות, כך שכל הזדמנות מקבלת מענה מסודר וכל עדכון נשאר קל לניהול.',
        },
        {
          title: 'אוטומציה של תהליכי עבודה',
          desc: 'מערכות מותאמות אישית שמפנות לך זמן, משפרות דיוק ומאפשרות לעסק לעבוד בצורה חלקה גם כשהיומן עמוס.',
        },
        {
          title: 'ניתוח עלויות ותשתית',
          desc: 'אני בודק את מערך הטכנולוגיה שלך כדי לאתר הזדמנויות לחיסכון, לשפר ביצועים ולבנות תשתית יעילה יותר לטווח ארוך.',
        },
        {
          title: 'רשת ביטחון 24/7',
          desc: 'שקט נפשי מלא עם תמיכה זמינה, תחזוקה שוטפת ותשתית שמוכנה לרגעים החשובים של העסק שלך.',
        },
      ],
    },
    process: {
      ...
      steps: [
        {
          ...
          desc: 'אני בודק לעומק את המערכות כדי לזהות הזדמנויות לשיפור, חיסכון, מהירות וצמיחה.',
        },
        {
          title: 'בנייה מותאמת',
          desc: 'אני מיישם מערכות בעלות ביצועים גבוהים שמותאמות בדיוק לתהליך העבודה, לקהל וליעדים העסקיים שלך.',
        },
        {
          title: 'מסירה והמשך ליווי',
          desc: 'אתה מקבל מערכת פשוטה לניהול, הסבר ברור ותשתית יציבה שמאפשרת לך להמשיך להתקדם בביטחון.',
        },
      ],
    },
    portfolio: {
      ...
      projects: [
        ...
        },
        {
          ...
          desc: 'אתר תדמית אסטרטגי לחברת מודיעין עסקי, סייבר וייעוץ ביטחוני, עם שפה ויזואלית דיסקרטית, יוקרתית ומדויקת. האתר מציג מעטפת שירותים רב-תחומית לאתגרים מורכבים של אבטחה, חקירה וניהול סיכונים.',
          before: 'חברה מקצועית שחיכתה לנוכחות דיגיטלית מדויקת ובטוחה',
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Simple CRM and CMS tools for leads, content, and clients, so every opportunity is organized and every update stays easy.',
        },
        {
