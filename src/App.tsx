    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          className='fixed bottom-44 end-8 z-50 p-4 bg-primary text-white rounded-full shadow-2xl hover:bg-primary-container hover:-translate-y-1 transition-all duration-[250ms] active:scale-90'
