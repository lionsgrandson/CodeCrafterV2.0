    ...
    <header className="relative pt-32 pb-24 px-6 md:px-8 overflow-hidden bg-surface">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        <motion.div 
          ...
          className="z-10"
        >
          <span className="text-primary font-headline font-bold tracking-widest uppercase text-xs mb-4 block underline-offset-4 decoration-primary/30 underline">{t.hero.eyebrow}</span>
